...
print(f"First has_pending_update_operations before update : {table_client.has_pending_update_operations()}")
...
print(f"Second has_pending_update_operations before clear : {table_client.has_pending_update_operations()}")
table_client.clear_pending_update_operations()
print(f"Third has_pending_update_operations after clear : {table_client.has_pending_update_operations()}")
